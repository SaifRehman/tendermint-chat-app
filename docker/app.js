...
expressapp.post('/api/abci_query', cors(), function (req, res) {
...
expressapp.post('/api/block', cors(), function (req, res) {
  var height = req.body.height;
...
expressapp.post('/api/block_results', cors(), function (req, res) {
  var height = req.body.height;
...
expressapp.post('/api/blockchain', cors(), function (req, res) {
...
expressapp.post('/api/broadcast_tx_async', cors(), function (req, res) {
  var tx = req.body.tx;
...
expressapp.post('/api/broadcast_tx_commit', cors(), function (req, res) {
  var tx = req.body.tx;
...
expressapp.post('/api/broadcast_tx_sync', cors(), function (req, res) {
  var tx = req.body.tx;
...
expressapp.post('/api/subscribe', cors(), function (req, res) {
...
expressapp.post('/api/tx', cors(), function (req, res) {
...
expressapp.post('/api/tx_search', cors(), function (req, res) {
  var query = req.body.query;
  var prove = req.body.prove;
